...
gemini_key = 'AIzaSyBquOQAD9hvTmEbk7poX88RfzMlyi6pTZo'
...
def grade_essay(essay_content):
  if len(essay_content)>40:
     ...
     st.write("Predicted grade:", preds[0][0])
...
image_path = "images (12).jpeg"  # Change to your image file path
image = Image.open(image_path)  # Open the image with PIL
st.image(image,use_column_width=True)  # Display the image with a caption


grading_option = st.selectbox("What would you like to do?", ["Grade an Essay", "Grade based on Synoptic"])
